...
export default function CallToAction() {
  return (
    <section className="py-20 md:py-28 px-4 md:px-6 lg:px-8 bg-linear-to-br from-orange-500 via-orange-600 to-orange-500 dark:from-orange-600 dark:via-orange-700 dark:to-orange-600 relative overflow-hidden">
